...
export class DashboardChart implements OnChanges {
  ...
  renderChart() {
    ...
    const y = d3.scaleLinear()
      .domain([0, d3.max(this.data, d => d.revenue || d.balance || 0) || 100])
      .range([height, 0]);
    ...
    svg.selectAll('.bar')
      ...
      .append('rect')
      .attr('class', 'bar')
      .attr('x', d => x(d.month || d.name)!)
      .attr('width', x.bandwidth())
      .attr('y', d => y(d.revenue || d.balance || 0))
      .attr('height', d => height - y(d.revenue || d.balance || 0))
      .attr('fill', '#3b82f6');
  }
}
